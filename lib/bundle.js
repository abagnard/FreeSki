	  ...
	  _createClass(Game, [{
	    ...
	    value: function play() {
	      ...
	      if (this.skier.lives === 0) {
	        ...
	        return;
	      } else if (this.timeElapsed === 10 && this.skier.lives > 0 && this.gameOver === false) {
	        this.gameOver = true;
	        this.showWinModal();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BigTree = exports.BigTree = function (_MovingObject2) {
	  ...
	  _createClass(BigTree, [{
	    key: 'draw',
	    value: function draw(ctx) {
	      ctx.drawImage(this.bigTree, 94, 66, this.height, this.width, this.pos.x, this.pos.y, this.height, this.width);
	    }
	  }, {
	    key: 'clear',
	    value: function clear(ctx) {
	...
	var Snow = exports.Snow = function (_MovingObject4) {
	  ...
	  _createClass(Snow, [{
	    key: 'draw',
	    value: function draw(ctx) {
	      ctx.drawImage(this.snow, 181, 27, this.height, this.width, this.pos.x, this.pos.y, this.height, this.width);
	    }
	  }, {
	    key: 'clear',
	    value: function clear(ctx) {
