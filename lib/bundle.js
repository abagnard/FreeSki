	...
	var Skier = function () {
	  ...
	  _createClass(Skier, [{
	    ...
	    value: function collision(otherObject) {
	      if (this.pos.x < otherObject.pos.x + otherObject.width - 5 && this.pos.x + this.width > otherObject.pos.x + 5 && this.pos.y < otherObject.pos.y + otherObject.height + 20 && this.pos.y + this.height > otherObject.pos.y + 20) {
	        return true;
	      } else {
	        return false;
	      }
