	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function resetGame() {
	      ...
	      this.snowObjs.forEach(function (obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Snow = exports.Rock = exports.Tree = undefined;
	...
	var Snow = exports.Snow = function (_MovingObject3) {
	  _inherits(Snow, _MovingObject3);
	
	  function Snow() {
	    _classCallCheck(this, Snow);
	
	    var _this3 = _possibleConstructorReturn(this, (Snow.__proto__ || Object.getPrototypeOf(Snow)).call(this));
	
	    _this3.snow = new Image();
	    _this3.snow.src = 'images/natureObj.png';
	    _this3.height = 27;
	    _this3.width = 14;
	    return _this3;
	  }
	  ...
	  _createClass(Snow, [{
	    key: 'draw',
	    value: function draw(ctx) {
	      ctx.drawImage(this.snow, 29, 49, this.height, this.width, this.pos.x, this.pos.y, this.height, this.width);
	    }
	  }, {
	    key: 'clear',
	    value: function clear(ctx) {
