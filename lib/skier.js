...
class Skier {
  ...
  collision(otherObject){
    if (this.pos.x < otherObject.pos.x + otherObject.width - 10 && this.pos.x + this.width  > otherObject.pos.x - 10 &&
		this.pos.y < otherObject.pos.y + otherObject.height + 10 && this.pos.y + this.height > otherObject.pos.y + 10) {
      return true;
    } else {
      return false;
    }
